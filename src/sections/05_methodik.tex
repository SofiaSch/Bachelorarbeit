...
Hierbei handelt es sich um ein Generalisiertes Lineares Modell (GLM) mit einer Binomial-Verteilung und einer Logit-Link-Funktion, basierend auf dem methodischen Ansatz von Papke und Wooldridge (1996).
