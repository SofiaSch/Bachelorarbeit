...
Mit einer Struktur, die auf maximale Geschwindigkeit und das \endquote{Once-Only}- Prinzip ausgelegt ist, werden Zeitverzögerungen intensiver als Ressourcenbelastung interpretiert, wovon KMU aufgrund ihrer begrenzten Mittel stärker betroffen sind als Großunternehmen.
...
Dies deckt sich mit der Argumentation in \parencite{buerokratie_DE}, wonach gerade für den Mittelstand eine ausreichende Fristsetzung essenziell ist, um die bürokratischen Anforderungen einer Ausschreibung überhaupt bewältigen zu können.
