...
Die vorangegangene empirische Analyse hat gezeigt, dass der Zusammenhang zwischen Verfahrensdauer und Wettbewerb weitaus komplexer ist, als es die klassische Transaktionskostentheorie zunächst vermuten ließ.
Während die statistischen Tests das ‚Was‘ beantwortet haben, nämlich signifikante Divergenzen zwischen den Ländern, widmet sich dieses Kapitel dem ‚Warum‘.
...
Dies ist für den estnischen Markt von besonderer Relevanz, da KMU dort mit durchschnittlich 87\ \% den mit Abstand größten Anteil an den Bietern stellen, während dieser in Deutschland (64\ \%) und Frankreich (29\ \%) deutlich geringer ausfällt.
Dieser hohe Wert für Estland ist jedoch nicht allein auf verfahrenstechnische Gründe zurückzuführen, sondern spiegelt primär die nationale Wirtschaftsstruktur wider.
Als kleine Volkswirtschaft verfügt Estland über nur wenige Großunternehmen, sodass der Pool potenzieller Bieter fast ausschließlich aus KMU besteht.
Im Gegensatz dazu ist der französische Markt durch eine hohe Konzentration von Großkonzernen geprägt, was den geringen KMU-Anteil erklärt.
...
\begin{enumerate}
  ...
  \item Die Analyse verdeutlicht, dass in hocheffizienten Kontexten wie in Estland jede Verzögerung überproportional abschreckend auf KMU wirkt.
        ...
        Angesichts eines hohen KMU-Anteils an der gesamten Bieterstruktur in Estland haben Verzögerungen hier eine wesentlich breitere Hebelwirkung auf den Marktwettbewerb als in Frankreich und Deutschland.
...
Gleichzeitig muss kritisch angemerkt werden, dass eine Maximierung der KMU-Beteiligung um jeden Preis, etwa durch eine extreme Kleinteiligkeit bei der Losaufteilung, auch volkswirtschaftliche Nachteile haben kann.
Eine zu starke Fragmentierung von Aufträgen erhöht die Koordinationskosten aufseiten der staatlichen Vergabestellen massiv und kann Schnittstellenrisiken schaffen.
Für bestimmte Großprojekte kann die Bündelung bei einem Generalunternehmer effizienter sein als die Koordination vieler kleiner Gewerke.
Die Förderung von KMU sollte daher immer gegen die entstehenden Transaktionskosten auf Auftraggeberseite abgewogen werden.
...
Ein weiterer Ansatzpunkt für zukünftige Forschung ergibt sich aus dem Fokus dieser Arbeit auf die reine Beteiligungsintensität.
Folgestudien sollten untersuchen, ob die Verfahrensdauer auch die tatsächlichen Zuschlagschancen beeinflusst.
...
Zukünftige Forschung sollte zudem untersuchen, inwieweit die hier festgestellten länderspezifischen Unterschiede direkt mit der strukturellen Zusammensetzung der Bieterlandschaft korrelieren, die von 87\ \% KMU-Anteil in Estland bis hin zu lediglich 29\ \% in Frankreich reicht.

Über diese inhaltliche Vertiefung hinaus bietet das Forschungsdesign Potenzial für eine geographische und zeitliche Ausweitung.
Zukünftige Studien könnten weitere europäische Staaten einbeziehen, um die Ergebnisse zu validieren, oder durch eine Binnenanalyse, etwa der deutschen Bundesländer, den Einfluss regionaler Verwaltungskulturen beleuchten.
Schließlich könnte eine Längsschnittanalyse, die Veränderungen über einen längeren Zeitraum beobachtet, wertvolle Erkenntnisse zur Evolution der Vergabepraxis liefern.