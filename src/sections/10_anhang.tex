\newpage
\patchcmd{\section}{\thesection}{\appendixname\ \thesection}{}{}
\appendix
\section{Anhang}
\label{sec:anhang}

\DeclareCaptionContents{table}{\addcontentsline{toc}{subsection}{\protect\numberline{\thetable}#1}}
% Nummerierung auf A1, A2... umstellen und Zähler zurücksetzen
\renewcommand{\thetable}{A\arabic{table}}
\setcounter{table}{0}

% --- Tabelle A1: Stichprobenreduktion (Vollbildbreite) ---
\begin{table}[htbp]
    \centering
    \begin{threeparttable}
        ...
        \begin{tablenotes}[flushleft, para]
            \vspace{0.1cm}
            \footnotesize
            \textit{Anmerkung:} Die Reduktion resultiert primär aus fehlenden Angaben zum Auftragswert sowie zur Verfahrensart. [cite: 289]
        \end{tablenotes}
    \end{threeparttable}\label{tab:table5}
\end{table}

% --- Tabelle A2: Korrelationsmatrix (Korrektur) ---
\begin{table}[htbp]
    \centering
    \begin{threeparttable}
...
% --- Tabelle A3: Robustheitsprüfung (Gestreckt) ---
\begin{table}[htbp]
    \centering
    \begin{threeparttable}
...
% --- Tabelle A4: Robustheitsprüfung 2 (Vollbildbreite) ---
\begin{table}[htbp]
    \centering
    \begin{threeparttable}
...
\newpage
\section*{A5 Digitale Anhänge und Code-Verfügbarkeit}
\addcontentsline{toc}{subsection}{A5 Digitale Anhänge und Code-Verfügbarkeit}

Zur Gewährleistung der wissenschaftlichen Transparenz und Replizierbarkeit sind die im Rahmen dieser Arbeit entwickelten Skripte in öffentlichen Repositories hinterlegt.
...
\begin{table}[htbp]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} l}
            \toprule
            Komponente & Repository-Link (GitHub) \\
            \midrule
        ...
        \begin{tablenotes}[flushleft, para]
            \vspace{0.1cm}
            \footnotesize
            \textit{Anmerkung:} Die Repositories enthalten eine README-Datei mit Instruktionen zur Ausführung der Skripte sowie die verwendete \texttt{requirements.txt} für die Python-Umgebung.
        \end{tablenotes}
    \end{threeparttable}\label{tab:table6}
\end{table}