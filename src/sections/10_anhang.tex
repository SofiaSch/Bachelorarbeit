...
\begin{table}[htbp]
    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{p{2.5cm} l}
            ...
            \addlinespace
            \textbf{Daten} & \url{https://drive.google.com/drive/folders/1nJt4yDIWEa7CAUMGau34u-niXPlOxGi_} \\
            \textit{Inhalt:} & Vollständige Datensätze im JSON Format für Estland, Frankreich und Deutschland \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}[flushleft, para]
            \vspace{0.1cm}
