...
\subsection{Forschungsdesign}\label{subsec:foschungsdesign}

\textcolor{red}{
Für die Beantwortung der Forschungsfrage wird ein quantitatives, komparatives Ex-post-facto-Forschungsdesign angewendet.
Das Design ist quantitativ, da die Hypothesen mittels statistischer Regressionsanalysen auf Basis numerischer Daten getestet werden.
Es ist komparativ, da es auf einem gezielten Vergleich der drei Länder Deutschland, Frankreich und Estland nach dem "Most Different Systems Design" (MDSD) basiert, um den Einfluss unterschiedlicher administrativer Kontexte zu untersuchen.

Die Analyse beruht auf einem Ex-post-facto-Ansatz, da auf bereits abgeschlossene Vergabeverfahren aus der Vergangenheit zurückgegriffen wird, ohne dass die Variablen experimentell manipuliert werden.
Die Datengrundlage ist ein longitudinaler Sekundärdatensatz der Plattform OpenTender, der den Zeitraum von 2014 bis 2022 umfasst.
Diese Vorgehensweise ermöglicht es, den Zusammenhang zwischen der Verfahrensdauer und dem Wettbewerb unter realen Bedingungen zu analysieren und gleichzeitig für zeitliche Trends und länderspezifische Gegebenheiten zu kontrollieren.
}
