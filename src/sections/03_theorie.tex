...
Als öffentliche Auftragsgeber werden alle Dienststellen des Bundes, der Länder, Gemeindeverbände sowie sonstige juristische Personen des öffentlichen Rechts definiert, wie beispielsweise Hochschulen.
...
Im Jahr 2014 wurde ein großer Schritt im europäischen Vergaberechts gemacht, da neue EU-Vergaberichtlinien verabschiedet wurden~\parencite{Oeffentliche_Auftraege_DE}.
...
Diese umfassen Regeln, Dokumentationspflichten und mehrstufige Abläufe und bilden somit die Bürokratie des Vergabewesens.
...
Außerdem die Personalbindung, da sich wichtige Mitarbeiter mit der Ausschreibung befassen und ihre Kapazitäten in Ausarbeitung des Angebots stecken müssen.
...
Hinzu kommt das Recht der Kommunen auf Selbstverwaltung, wodurch sie ihre Verfahren ebenfalls eigenständig regeln können.
...
Diese administrative Professionalisierung entspricht einer höheren Akzeptanz digitaler Prozesse.
