...
Als zentrales Prinzip gilt der Grundsatz des Wettbewerbs, der dazu führt, dass alle weiteren Prinzipien erreicht werden~\parencite{Oeffentliche_Auftraege_DE}.
...
Außerdem die Personalbindung, da sich wichtige Mitarbeiter mit der Ausschreibung befassen und ihre Kapazitäten in Ausarbeitung des Angebots einbringen müssen.
...
Der Effekt tritt bei KMU stärker auf, trotz der neuen Reform, was dazu führt, dass diese aus dem Wettbewerb verdrängt werden~\parencite{PPP_transparency}.
...
Im Gegensatz zu zentralisierten Systemen obliegt die Durchführung komplexer EU-weiter Ausschreibungen in Deutschland weiterhin häufig den dezentralen Bedarfsstellen vor Ort.
...
Dadurch haben die Bürger eine zentrale Stelle, an der alle Informationen gesammelt und aktualisiert werden.
...
Diese Maßnahmen haben einen großen Einfluss.
Nicht nur auf die Bürger, sondern auch auf die Wirtschaft.
