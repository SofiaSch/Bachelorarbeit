...
Allein in Deutschland flossen im Jahr 2019 rund 35 \% der Staatsausgaben – ein dreistelliger Milliardenbetrag – über diesen Kanal in die Wirtschaft, wobei Länder und Kommunen die größten Auftraggeber sind~\parencite{Oeffentliche_Auftraege_DE}.
...
Als öffentliche Auftragsgeber zählen alle Dienstellen des Bundes, der Länder, Gemeindeverbänden und sonstigen juristischen Personen des öffentlichen Rechts, wie zum Beispiel Hochschulen.
Zudem kommen noch weitere Einrichtungen, die vom Staat finanziert werden (z.B. Krankenhäuser) und weitere Besonderheiten~\parencite{Oeffentliche_Auftraege_DE}.


Erklärung Schwellenwerte

Die wichtigsten Vergabearten
...
\subsection{Der Länderspezifische Verwaltungskontext als Moderator}