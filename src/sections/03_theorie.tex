...
Mit etwa 12\% des Bruttoinlandsprodukts (BIP) und fast einem Drittel der Staatsausgaben innerhalb der OECD werden erhebliche Mittel in Infrastruktur, Güter und Dienstleistungen gelenkt~\parencite{Value_Creation_in_PP}.
...
Dadurch haben sich grundlegende Prinzipien für das Vergabeverfahren etabliert, die darauf abzielen, das objektiv beste Angebot mit optimaler Preis-Leistung-Relation auszuwählen.
...
Als zentrales Prinzip gilt der Grundsatz des Wettbewerbs, der dazu führt, dass alle anderen Prinzipien erreicht werden~\parencite{Oeffentliche_Auftraege_DE}.
...
Wie auch die indirekten Kosten, zum Beispiel die Such- und Informationskosten sowie die Verhandlungs- und Entscheidungskosten~\parencite{transaktionskosten_2}.
...
Dementsprechend werden sich Unternehmen gegen eine Angebotsabgabe bei übermäßig langen Verfahren entscheiden~\parencite{Discretion_supplier_selection}.
...
Diese Kombination aus geringeren und erhöhten Ressourcen kann dazu führen, dass der Abschreckungseffekt bei einem langen Verfahren mit hohen Transaktionskosten überproportional hoch ist.
...
Nationale Unterschiede in der Behördenstruktur (etwa zentralisiert versus föderal) und im Digitalisierungsgrad beeinflussen entscheidend, wie effizient die EU-Vorgaben in die Praxis umgesetzt werden.
...
Dazu kommt das \endquote{Once-Only}-Prinzip.
...
Dieses hohe Maß an institutionalisierter Effizienz und der Digitalisierung positioniert Estland als einen \endquote{Best-Practice}-Fall im europäischen E-Government, dessen administrative Logik sich fundamental von der Deutschlands und Frankreichs unterscheidet.
...
Durch das gesetzlich verankerte \enquote{Once-Only}-Prinzip und die X-Road-Infrastruktur werden die Transaktionskosten für Bieter systematisch minimiert, da Nachweise automatisch abgerufen werden.
