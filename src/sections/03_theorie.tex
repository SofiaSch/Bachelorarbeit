...
Die Existenz von rund 30.000 Vergabestellen, kombiniert mit heterogenen Landes- und Kommunalregeln sowie einer geringen digitalen Nutzerakzeptanz, schafft Unübersichtlichkeit und mangelnde Berechenbarkeit.
Eine lange Verfahrensdauer dürfte hier stark als Signal für hohe, unkalkulierbare Bürokratie wirken.

In Frankreich agieren Unternehmen in einem zentralistischen System mit landesweit einheitlichen Vergaberegeln (Code de la commande publique) und einer starken zentralen Beschaffungsstelle (UGAP).
Gepaart mit einer signifikant höheren Akzeptanz digitaler Behördendienste (87\% Nutzung), erscheint das System, obwohl ebenfalls bürokratisch, als wesentlich berechenbarer und einheitlicher als das deutsche.

In Estland trifft die Verfahrensdauer auf ein \("\)Digital-by-Default\("\)-System, das auf maximale Effizienz für den Nutzer ausgelegt ist.
Durch das gesetzlich verankerte "Once-Only"-Prinzip und die X-Road-Infrastruktur werden die Transaktionskosten für die Bieter (z.B. das Einreichen von Nachweisen) systemisch minimiert.
Eine lange Verfahrensdauer signalisiert hier am ehesten eine hohe Komplexität des Auftrags selbst, nicht aber eine Ineffizienz der Verwaltung.

Die in Tabelle 1 dargestellten Unterschiede stützen die Annahme, dass die abschreckende Wirkung langer Verfahrensdauern kein universelles Phänomen ist, sondern maßgeblich vom nationalen Verwaltungskontext moderiert wird.
