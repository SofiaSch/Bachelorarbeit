...
Die öffentliche Auftragsvergabe ist ein entscheidender Hebel für Wirtschaftswachstum und Innovation~\parencite{Value_Creation_in_PP}.
Trotz dieser Bedeutung stehen öffentliche Ausschreibungen häufig in der Kritik, da übermäßige bürokratische Hürden, insbesondere kleine und mittlere Unternehmen (KMU), vom Wettbewerb ausschließen.
...
Während Estland als digitaler Vorreiter auf maximale Geschwindigkeit setzt, sind Systeme, wie jene in Deutschland und Frankreich, durch tief verwurzelte föderale oder zentralistische Strukturen geprägt.
Diese suggerieren eine andere zeitliche Dynamik.

Hier setzt die vorliegende Arbeit an und positioniert sich im untersuchten Spannungsfeld.
...
Diese Forschungslücke adressiert die folgende Arbeit.
...
Zur Beantwortung dieser Frage wird eine quantitative Analyse auf Basis der Daten der Plattform OpenTender.eu durchgeführt.
