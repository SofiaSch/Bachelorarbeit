...
Hinsichtlich der unabhängigen Variable, der Verfahrensdauer, zeigt sich, dass Deutschland mit durchschnittlich 42,69 Tagen (Median: 32) die längsten Fristen ansetzt, gefolgt von Frankreich (Mittelwert: 38,33; Median: 32).
Estland weist eine vergleichbare Median-Dauer von 33 Tagen auf, jedoch bei einer geringeren Standardabweichung.
...
Zur weiteren Veranschaulichung der zentralen unabhängigen Variable (Verfahrensdauer) zeigt Abbildung~\ref{fig:boxplot_dauer} die Verteilung der Fristen in den drei Ländern.
...
\begin{figure}[H] % [H] ZWINGT DAS BILD HIERHIN
    \centering
