...
Die empirische Analyse der Vergabedaten bringt Muster zutage, die teilweise intuitiv erscheinen, an entscheidenden Stellen jedoch gängigen Annahmen widersprechen.
...
Bei den erfolgreichen Ausschreibungen (Gebote $>0$) ist der Wettbewerb in Deutschland am intensivsten (Mittelwert: 1,13 Gebote), während Frankreich (Mittelwert: 0,13) und Estland (Mittelwert: 0,65) deutlich niedriger liegen.
...
Die Grafik illustriert die vorhergesagte Wahrscheinlichkeit des KMU-Anteils unter an den Bietern.
