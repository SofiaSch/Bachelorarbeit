...
Zur Überprüfung von Hypothese 1 (H1) und Hypothese 3 (H3) wurde ein Zero-Inflated Negative Binomial (ZINB) Modell berechnet.
...
Für Estland (Referenz) ist der Effekt der Verfahrensdauer negativ ($-0,026$), aber statistisch nicht signifikant ($p=0,681$).
...
Diese unerwarteten Befunde, insbesondere die gegensätzlichen Effekte in Estland im Vergleich zu den großen Volkswirtschaften, werfen Fragen zur Wahrnehmung von Verfahrensdauer in unterschiedlichen Verwaltungssystemen auf, die im folgenden Kapitel diskutiert werden.