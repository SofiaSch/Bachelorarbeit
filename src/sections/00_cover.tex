...
\begin{singlespacing} %
    ...
    {\huge\bfseries Bürokratie in der öffentlichen Auftragsvergabe\par}
    \vspace{0.5cm} % Sauberer Abstand zwischen Haupt- und Untertitel
    {\Large Der Einfluss der Verfahrensdauer auf Wettbewerb und KMU-Beteiligung in Deutschland, Estland und Frankreich\par}
